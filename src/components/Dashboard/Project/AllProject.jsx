...
const AllProject = () => {
  ...
  const fetchUserProjects = async () => {
    try {
      ...
      const projectsResponse = await fetch(
        `${API_URL}/api/projects/user/list`,
        {
          headers: {
                ...
                <div className="p-8 md:p-12">
                  <div className="flex justify-center mb-8">
                    <div className="relative">
                      ...
                      <div className="relative w-28 h-28 bg-linear-to-br from-gray-800 to-gray-900 rounded-2xl flex items-center justify-center shadow-lg transform rotate-3 hover:rotate-6 transition-transform duration-300 border border-gray-700">
                        <svg
                          className="w-14 h-14 text-[#1EB97A]"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                  ...
                  <div className="text-center mb-8">
                    ...
                    <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
                      Ready to showcase your work? Start your journey by
                      submitting your first project to our platform.
                    </p>
                  </div>
                  ...
                  <div className="grid md:grid-cols-3 gap-6 mb-12">
                    <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-5 text-center hover:bg-gray-800 transition-all duration-300 border border-gray-700 hover:border-[#1EB97A]/30">
                      ...
                      <p className="text-sm text-gray-400">
                        Simple step-by-step process to submit your project
                      </p>
                    </div>
                    ...
                    <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-5 text-center hover:bg-gray-800 transition-all duration-300 border border-gray-700 hover:border-[#1EB97A]/30">
                      ...
                      <p className="text-sm text-gray-400">
                        Monitor your submission status in real-time
                      </p>
                    </div>
                  </div>
  ...
  return (
    <>
      <div className=" bg-black font-sans max-w-7xl mx-auto mb-20 mt-20">
        {/* Error Message */}
        {error && (
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          <div>
            ...
            <p className="text-gray-500 mt-1">
              Total Projects:{" "}
              <span className="text-[#1EB97A] font-semibold">
                {projects.length}
              </span>{" "}
        ...
        <div className="bg-linear-to-br from-gray-900 to-gray-950 rounded-2xl border border-gray-800 overflow-hidden shadow-2xl">
          ...
          {currentEntries.length === 0 ? (
            <div className="text-center py-16">
              ...
              <Link
                href="/projects/submit-film"
                className="inline-block mt-4 bg-linear-to-r from-[#1EB97A] to-[#189663] text-white px-6 py-2 rounded-xl"
              >
                Create Project
              </Link>
            </div>
                ...
                <tbody className="divide-y divide-gray-800">
                  {currentEntries.map((project, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`px-3 py-1 rounded-full text-xs font-medium border backdrop-blur-sm ${getProjectTypeBadgeColor(project.projectType || project.category)}`}
                        >
                          {project.projectType ||
                            project.category ||
                            "Not specified"}
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          {/* Submitter Avatar */}
                          <div className="w-8 h-8 rounded-full bg-linear-to-br from-gray-700 to-gray-800 flex items-center justify-center text-xs font-bold text-gray-300 border border-gray-700 overflow-hidden">
                            {project.submitter?.profileImage ? (
                              <img
                                src={project.submitter.profileImage}
                                alt={
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {project.mediaLink && (
                            <a
                              ...
                              className="p-1.5 bg-blue-500/20 hover:bg-blue-500/30 rounded-lg transition-colors group/media"
                              title="View Media Link"
                            >
                              <svg
                                className="w-4 h-4 text-blue-400 group-hover/media:text-blue-300"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                              >
                          ...
                          {project.uploadedImage && (
                            <button
                              onClick={() => {
                                // Open image preview modal or new tab
                                window.open(project.uploadedImage, "_blank");
                              }}
                              className="p-1.5 bg-purple-500/20 hover:bg-purple-500/30 rounded-lg transition-colors group/img"
                              title="View Poster Image"
                            >
                              <svg
                                className="w-4 h-4 text-purple-400 group-hover/img:text-purple-300"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                              >
                          ...
                          {/* No Media */}
                          {!project.mediaLink && !project.uploadedImage && (
          ...
          >
            ...
            >
              ...
              <div className="p-8 space-y-8">
                      ...
                      <div className="flex flex-wrap gap-2 mt-3">
                        ...
                        <span
                          className={`inline-flex items-center gap-1 px-2 py-1 rounded-lg text-xs font-medium ${
                            selectedProject.submissionStatus === "approved" ||
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-gray-300">
                        {selectedProject.director || "Not specified"}
                      </p>
                    </div>
                    ...
                    <div className="border-t border-gray-800 pt-4 mt-2">
                      <div className="text-center py-6">
                        ...
                        <p className="text-gray-500 text-xs mt-1">
                          No trailer link or poster image uploaded for this
                          project
                        </p>
                      </div>
                    </div>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="bg-gray-900 rounded-xl p-3 border border-gray-700">
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="text-[#1EB97A] hover:text-emerald-400 text-sm break-all flex items-center gap-2 group"
                            >
                              <svg
                              ...
                              {selectedProject.mediaLink.length > 50
                                ? selectedProject.mediaLink.substring(0, 50) +
                                  "..."
                                : selectedProject.mediaLink}
                            </a>
                          </div>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative group">
                            <div className="bg-gray-900 rounded-xl overflow-hidden border border-gray-700">
                              <img
                                src={selectedProject.uploadedImage}
                                alt="Project poster"
                ...
                {(selectedProject.hasNonEnglishTitle ||
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      ...
                      {selectedProject.nonEnglishSynopsis && (
                        <div className="space-y-1">
                          ...
                          <p className="text-gray-400 text-sm bg-gray-900/50 p-3 rounded-xl">
                            {selectedProject.nonEnglishSynopsis}
                          </p>
                        </div>
                      )}
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="space-y-1">
                            {selectedProject.writers.map((w, idx) => (
                              ...
                              >
                                <p className="text-gray-300 text-sm font-medium">
                                  {`${w.firstName || ""} ${w.middleName || ""} ${w.lastName || ""}`.trim() ||
                                    "N/A"}
                                </p>
                                {w.priorCredits && (
                                  <p className="text-xs text-gray-500 mt-1">
                ...
                <div className="bg-gray-800/50 rounded-2xl p-6 border border-gray-700">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="space-y-1">
                      ...
                      <p className="text-gray-300 font-medium">
                        {formatRuntime(selectedProject)}
                      </p>
                    </div>
                    <div className="space-y-1">
                      <label className="text-xs text-gray-500">Genres</label>
                      <p className="text-gray-300">
                        {selectedProject.genres || "N/A"}
                      </p>
                    </div>
                    <div className="space-y-1">
                      <label className="text-xs text-gray-500">Language</label>
                      <p className="text-gray-300">
                        {getLanguageName(selectedProject.language)}
                      </p>
                    </div>
                    <div className="space-y-1">
                      ...
                      <p className="text-gray-300">
                        {selectedProject.shootingFormat || "N/A"}
                      </p>
                    </div>
                    <div className="space-y-1">
                      <label className="text-xs text-gray-500">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-gray-300">
                        {selectedProject.filmColor || "Color"}
                      </p>
                    </div>
                    <div className="space-y-1">
                      <label className="text-xs text-gray-500">
                      ...
                      <p className="text-gray-300">
                        {selectedProject.studentProject || "No"}
                      </p>
                    </div>
                    <div className="space-y-1">
                      <label className="text-xs text-gray-500">
                      ...
                      <p className="text-gray-300">
                        {selectedProject.firstTimeFilmmaker || "No"}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-800/50 rounded-2xl p-6 border border-gray-700">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      ...
                      <p className="text-gray-300 break-all">
                        {selectedProject.email ||
                          selectedProject.submitterEmail ||
                          "N/A"}
                      </p>
                    </div>
                    <div className="space-y-1">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-gray-300">
                        {selectedProject.gender || "N/A"}{" "}
                        {selectedProject.pronouns
                          ? `(${selectedProject.pronouns})`
                          : ""}
                      </p>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-3">
                      {selectedProject.website && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center gap-2 px-3 py-2 bg-gray-900 hover:bg-gray-800 rounded-xl text-sm text-gray-400 transition"
                        >
                          🌐 Website
                        </a>
                      )}
